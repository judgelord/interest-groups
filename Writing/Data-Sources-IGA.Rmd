...
Since 1994, when the government first released the *Federal Register* online, scholars have had access to increasingly detailed data on the notice-and-comment rulemaking process, including draft policies, the activities of policymakers, and interest group advocacy. 
...
Interest groups lobby successfully in OMB review [@HaederAPSRYackee2015]. [NOTE: reference to IG&A OMB article here].  Interest groups also use the rulemaking record to build a case for litigation. 
...
\bigskip
\noindent 
**Office of Management and Budget (OMB) data:** As is covered elsewhere in this issue [NOTE: reference to OMB article here], many rules, especially rules that are controversial or economically significant, are reviewed by OMB's Office of Information and Regulatory Affairs (ORIA). Obtaining ORIA data is relatively straightforward, as all of these documents since 1981 are available online in machine-readable form. These data include the date on which ORIA received the rule from the agency, whether the review was expedited, and whether the rule is determined to by "economically significant" or affect "Federalism."
\bigskip
\noindent 
