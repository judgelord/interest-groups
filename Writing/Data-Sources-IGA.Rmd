...
Open Secrets also has a database on revolving door employees that shows the career paths or federal government workers that went to the private sector work that depends on interacting with the federal government.^[See https://www.opensecrets.org/revolving/methodology.php.  Unlike their lobbying database, this one has no bulk data option and must be scraped.]
...
Second, scholars must determine how to preprocess the rulemaking data before feeding the data to a text analysis algorithm.
