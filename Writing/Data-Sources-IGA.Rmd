...
The Federal Reserve, for example, groups meetings by subject, not by rule,^[https://www.federalreserve.gov/regreform/communications-with-public.htm] the Securities and Exchange Commission groups meetings by rule, and the Commodity Futures Trading Commission
 and Federal Communication Commission meeting records are not grouped at all.^[See https://www.cftc.gov/LawRegulation/DoddFrankAct/ExternalMeetings?page=6 and https://www.fcc.gov/proceedings-actions/ex-parte/archive-of-filings]
