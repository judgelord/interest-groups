...
The data are astonishingly complete - the website contains all 6264 FARA registrants and their foreign contacts since  1942.^[https://efile.fara.gov/ords/f?p=1381:1:13132679194789:::::]  Unlike other data discussed in this essay, the FARA data is *not* all in machine-readable form.^[Only the metadata (e.g. names) are machine readable.] 
