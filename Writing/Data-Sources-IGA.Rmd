...
Each year, agencies publish four thousand or more regulations. In doing so, agencies must follow a process prescribed by the Administrative Procedures Act (APA), 5 U.S.C. § 553(c). 
...
These documents are organized in a "docket" folder with a unique name and ID number. Once kept in literal folders in each agency's "docket room," where visitors could make photocopies, these documents are now online. For example, the Centers for Medicare Medicaid Services rulemaking docket 0163 "Transparency in Coverage" can be found at regulations.gov/docket?D=CMS-2019-0163.
...
The notion that interest groups seek to influence rules motivates scholarly interest in patterns of participation in rulemaking.
...
Interest groups lobby successfully in OMB review [@HaederYackee2015]. [NOTE: reference to IG&A OMB article here].  Interest groups also use the rulemaking record but build a case for litigation. 
