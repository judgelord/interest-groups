...
comments\footnote{The difference between the total number of reported
  comments and the number of comments on regulations.gov is often
  because mass comment campaigns are grouped together.} and confidential
...
which is on Goldman Sachs letterhead.\footnote{See
...
rulemaking issues share acronyms or have similar names.
