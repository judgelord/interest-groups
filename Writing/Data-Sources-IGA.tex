...
in rulemaking from the agency websites.\footnote{For example, the
  Federal Energy Regulatory Commission posts all comments they receive
  on their eLibrary website but only posts some on regulations.gov.
  Unlike regulations.gov, most agency sites do not have an API and thus
  require scholars to use bespoke web scrapers. We have examples of
  scrapers for several of these agencies on
...
\noindent \textbf{Office of Management and Budget (OMB) data:} As
addressed elsewhere in this issue {[}NOTE: reference to OMB article
...
and Regulatory Affairs (ORIA). Obtaining ORIA data is relatively
...
ORIA received the rule from the agency, whether the review was
expedited, and whether the rule is determined to by `economically
significant' or affect `federalism'.

\bigskip

\noindent \textbf{Press releases}: In addition to disclosures mandated
by law, agencies often issue press releases for agency actions. Much
like the meetings data discussed above, policies regarding the storage
and dissemination of press releases differ from agency to agency. The
