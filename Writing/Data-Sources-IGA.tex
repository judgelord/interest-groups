...
to learn about rulewriters' identities and networks. Some of the most
...
classify the ideology of agencies over time and apply these measures to
...
with stakeholders. The legally operative text of the rule is often less
useful to social scientists since interpretating legal text often
requires substantial domain expertise. However, where interpretation is
straightforward, such as rate-setting scholars can capture variation in
legally operative texts \citep[ and
\citet{GordonRashinJOP}]{BallaAPSR1998}.
